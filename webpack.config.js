...
// basic configuration:
const title = 'Aurelia app cli demo';
const baseUrl = '/';
...
const baseConfig_github_pages = {
  ...
  output: {
    path: outDir,
    publicPath: '/aurelia-app-cli-sample/'
  }
}
...
switch (ENV) {
 ...
 case 'gh-pages':
    config = generateConfig(
      baseConfig_github_pages,

      require('@easy-webpack/config-env-production')
        ({compress: true}),
        
      require('@easy-webpack/config-aurelia')
        ({root: rootDir, src: srcDir, title: title, baseUrl: '/aurelia-app-cli-sample/'}),
