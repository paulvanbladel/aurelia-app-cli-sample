define('app',['exports'], function (exports) {
  ...
  var App = exports.App = function () {
    ...
    App.prototype.configureRouter = function configureRouter(config, router) {
      ...
      config.map([{ route: ['', 'cli-intro'], name: 'cli-intro', moduleId: './cli-intro', nav: true, title: 'cli-intro' }, { route: 'welcome', name: 'welcome', moduleId: './welcome', nav: true, title: 'Welcome' }, { route: 'child-router', name: 'child-router', moduleId: './child-router', nav: true, title: 'Child Router' }]);
...
define('main',['exports', './environment', './Commands/index', 'node_modules/babel-polyfill/dist/polyfill.js'], function (exports, _environment, _index) {
  'use strict';
